...
public class ProductControllerTest {
    ...
    public void addProductTest() throws Exception {
        //given
        ProductDTO dto = new ProductDTO(null, "pear", 33, BigDecimal.valueOf(35.89));
        Product product = new Product(1000L, "pear", 33, BigDecimal.valueOf(35.89));

        doReturn(product).when(productService).addProduct(eq(dto));
    ...
    public void updateProductTest() throws Exception {
        ...
        doReturn(product).when(productService).getProduct(product.get().getId());
        doReturn(updProduct).when(productService).updateProduct(product.get().getId(), updProduct);
